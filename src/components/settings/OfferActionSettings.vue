    ...
    <div class="container">
      <div class="body">
        <div class="layout-labels-top layout-inline-grid-double">
          ...
          >
            <label for="offeraction-pagetemplate">Page Template</label>
            <select
              id="offeraction-pagetemplate"
              v-model="settings.offeraction.pageTemplate"
            >
          ...
          >
            <input
              id="offeraction-hideassignmentheader"
              type="checkbox"
              v-model="settings.offeraction.hideassignmentheader"
            />
            <label class="width-auto" for="offeraction-hideassignmentheader"
