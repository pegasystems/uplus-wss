      ...
      <div class="body">
        ...
        <div class="layout-labels-top layout-inline-grid-double">
          ...
          >
            ...
            <select
              id="banner-pagetemplate"
              v-model="settings.banner.pageTemplate"
            >
          ...
          >
            <input
              ...
              type="checkbox"
              v-model="settings.banner.hideassignmentheader"
            />
            <label class="width-auto" for="banner-hideassignmentheader"
