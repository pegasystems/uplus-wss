<template>
  <div class="container-transparent">
    ...
    <p>
      ...
      <a href="https://github.com/pegasystems/uplus-wss/wiki/How-to-configure-the-Pega-Chat-bot">here</a>.
    </p>
    ...
    <Container title="Custom Events">
      <div v-for="(event, index) in settings.CustomEvents" :key="index" class="layout-labels-top" v-bind:key="index">
        <div class="flex event-header">
          ...
          <i @click="removeCustomEvent(index)" class="pi pi-trash remove-event"></i>
        </div>
        <div class="field-item">
          <label for="chat-CustomEventName">Event Name</label>
          <input id="chat-CustomEventName" type="text" v-model="event.CustomEventName" />
        </div>
        ...
        <div class="field-item">
          <label for="chat-ElementName">Element To Select (Enter the elements text value e.g. 'Log in')</label>
          <input id="chat-ElementName" type="text" v-model="event.ElementName" />
        </div>

        <div class="layout-labels-top layout-inline-grid-double">
          <div class="field-item field-checkbox">
            <input type="checkbox" v-model="event.SendAcknowledgement" :id="'chat-' + index + '-SendAcknowledgement'" />
            <label v-if="!event.SendAcknowledgement" class="width-auto"
              :for="'chat-' + index + '-SendAcknowledgement'">Send
              Event
      ...
      <a class="add-event" @click="addCustomEvent">Add Event <i class="pi pi-plus"></i> </a>
      <br />
      <br />
    </Container>
    ...
    <Container title="Proactive chat on page load" expanded>
      <div class="layout-labels-top layout-inline-grid-double">
        <div class="field-item">
          <label for="chat-DMMProactiveChatNewSessionTimeout">Time to wait (in ms) - use 0 to disable</label>
          <input id="chat-DMMProactiveChatNewSessionTimeout" type="number"
        ...
        <div class="field-item">
          ...
          <input id="chat-DMMProactiveChatNewSessionCode" type="text"
    ...
    <Container title="Co-Browse" expanded>
      <div class="layout-labels-top layout-inline-grid-double">
        <div class="field-item">
          ...
          <input id="chat-CoBrowseServerURL" type="text" v-model="settings.pega_chat.CoBrowseServerURL" />
        </div>
        <div class="field-item">
