  ...
  <div class="container-transparent">
    ...
    <Container title="Pega Chat" expanded>
      <div class="layout-labels-top layout-inline-grid-double">
        ...
        <div class="field-item">
          <label for="chat-WebChatBotID">WebChat Bot ID</label>
    ...
    <Container title="Co-Browse" expanded>
      <div class="layout-labels-top layout-inline-grid-double">
        <div class="field-item">
          <label for="chat-CoBrowseServerURL">Co-Browse URL</label>
          <input
        ...
        <div class="field-item">
          <label for="chat-CoBrowseToken">Co-Browse Token</label>
