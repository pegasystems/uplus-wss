...
/**
  ...
  <div class="flex layout-content-inline_middle main-header">
    ...
    <div class="flex layout-content-inline_middle margin-l-auto">
      <button type='button' class="pzhc pzbutton Simple"
      title='${i18n.t("Click to refresh the recent activty")}' @click="${i}">${i18n.t("Refresh")}</button>
      ${xt("Create","Create a new case",a,s)}
    </div>
  </div>
  ${e.length>0?T`
            ...
            ${e.map((t=>T`
                <tr>
                  <td data-title='Request Id'>
                    <button @click="${n}" class="pzhc pzbutton" data-type="assignment" data-id="${t.pzInsKey}">${t.pyID}</button>
                  </td>
...
`;class Ae extends be{displayContent(){return""!==this.errorMsg?we(this.errorMsg,"true"===this.bShowCancel?this.resetError:null):"oauth2password"!==this.authentication&&"oauth2clientcredentials"!==this.authentication||""!==this.token?(this.casetypes||"createNewWork"!==this.action&&"workList"!==this.action&&"recentactivity"!==this.action?""===this.name&&("openAssignment"===this.action&&""===this.assignmentID&&(this.assignmentID=this.caseID),""!==this.assignmentID?this.fetchData("assignment",{id:this.assignmentID}):""!==this.caseID&&this.fetchData("case",{id:this.caseID})):(this.fetchData("casetypes"),"createNewWork"===this.action?(this.bShowNew=!0,this.casetypes[this.casetype]&&this.fetchData("newwork",{id:this.casetype})):("workList"===this.action)?(this.bShowCancel="true",this.fetchData("worklist")):(this.bShowCancel="true",this.fetchData("recentactivity"))),this.bShowConfirm?Ce(this.casedata.content.pyLabel,this.casedata.content.pyID,this.casepyStatusWork,"true"===this.bShowAttachments?this.displayAttachments:null):""!==this.caseID||""!==this.assignmentID||this.bShowNew?(this.action==="recentactivity")?T`
      ...
      `:"workList"===this.action?De(this.title,this.cases,this.displayCasesTypes,this.reloadWorkList,"true"===this.bShowCreate?this.createCase:null,this.openCase):("recentactivity"===this.action?DDe(this.title,this.cases,this.displayCasesTypes,this.reloadWorkList,"true"===this.bShowCreate?this.createCase:null,this.openCase):null)):(this.sendData("authenticate",{}),null)}renderMainLayout=(t,e)=>ge(t,e,"true"===this.bShowCancel?this.actionAreaCancel:null,"true"===this.bShowSave?this.actionAreaSave:null,this);renderSaveCaseLayout=(t,e)=>me(t,e,"true"===this.bShowCancel?this.actionAreaCancel:null,"true"===this.bShowSave?this.actionAreaSave:null,this);renderReviewLayout=(t,e)=>fe(t,e,"true"===this.bShowCancel?this.actionAreaCancel:null,this);renderCreateCaseLayout=(t,e)=>$e(t,e,"true"===this.bShowCancel?this.actionAreaCancel:null);genPageValidationErrors=t=>(t=>t.errorDetails?T`
    <ul>
