...
/**
  ...
  `},Ht=(t,e,a,i)=>{if(void 0===t||void 0===t.control||void 0===t.control.type)return null;if(t.customAttributes&&"none"===t.customAttributes.display)return null;if(!0===a||!0===t.readOnly||"pxHidden"===t.control.type)return Ot(t,e,"field-text",Ft(t,e));if(i.casedata&&i.casedata.content){ht(i.casedata.content,t.reference)||("pxCheckbox"===t.control.type?dt(i.casedata.content,t.reference,"true"==t.value):dt(i.casedata.content,t.reference,t.value))}switch(t.control.type){case"pxPhone":case"pxTextInput":return Ot(t,e,"field-textinput",Vt(t,e));case"pxInteger":case"pxNumber":return Ot(t,e,"field-numberinput",Bt(t,e));case"pxCurrency":return Ot(t,e,"field-currencyinput",Wt(t,e));case"pxEmail":return Ot(t,e,"field-emailinput",Zt(t,e));case"pxTextArea":return Ot(t,e,"field-textarea",Yt(t,e));case"pxRadioButtons":return Ot(t,e,"field-radiogroup",ae(t,e));case"pxCheckbox":return Ot(t,e,"field-checkbox",ie(t,e));case"pxDropdown":return Ot(t,e,"field-dropdown",se(t,e));case"pxDisplayText":return Ot(t,e,"field-text",Ft(t,e));case"pxIcon":return Ot(t,e,"field-icon",Jt(t,e));case"pxLink":case"pxURL":return Ot(t,e,"field-url",Kt(t,e));case"pxIconDeleteItem":return Ot(t,e,"field-button",Gt(t,e));case"pxButton":return Ot(t,e,"field-button",Xt(t,e));case"pxDateTime":return"TimeOfDay"===t.type?Ot(t,e,"field-time",ee(t,e)):"Date"===t.type?Ot(t,e,"field-date",te(t,e)):Ot(t,e,"field-datetime",Qt(t,e));case"pxAutoComplete":return Ot(t,e,"field-combobox",ne(t,e));case"pxSlider":return Ot(t,e,"field-slider",jt(t,e));default:return null}},Ft=(t,e)=>{if("pxDate"===t.control.type){let a=ot(t.value);if(a)if(t.control&&2===t.control.modes.length){let e={};switch(t.control.modes[1].dateFormat){case"DateTime-Short-YYYY":case"Date-DayMonthYear-Custom":case"Date-Medium":e={year:"numeric",month:"short",day:"numeric"};break;case"Date-Short":e={year:"numeric",month:"numeric",day:"numeric"};break;case"Date-Long":e={year:"numeric",month:"long",day:"numeric"};break;case"Date-Full":e={weekday:"long",year:"numeric",month:"long",day:"numeric"};break;default:e={}}a=new Intl.DateTimeFormat([],e).format(a)}else a=(new Intl.DateTimeFormat).format(a);else a=t.value;return T`
    ...
    <input type="text" style="display:none" data-ref="${t.reference}" id="${Ut(e)}" value="${ct(t.value)}"/>
    ...
    <span class="dataValueRead" data-ref="${t.reference}" id="${Ut(e)}">${ct(a)}</span>
  `},Vt=(t,e)=>T`
  <input
    ...
    id="${Ut(e)}"
    value="${ct(t.value)}"
    data-action-change="${Ut(zt(t,"change"))}"
    data-action-click="${Ut(zt(t,"click"))}"
  />
`,jt=(t,e)=>T`
  <input
    data-ref="${t.reference}"
...
`,pe=(t,e,a,i,s,n,r,o,c,l)=>{const d=T`${at()}<span class='count-badge'>${s}</span>`;if(void 0===e.caseID&&a.content)return T`
    <div class="flex layout-content-inline_middle main-header">
      ...
      <div class="flex layout-content-inline_middle margin-l-auto">
        ...
        ${"true"===l&&a.actions&&a.actions.length>0?T`
  ...
  <div class="flex layout-content-inline_middle main-header">
    ...
    <div class="flex layout-content-inline_middle margin-l-auto">
      ${c?xt("Attachments",d,"Simple",c):""}
      ${"true"===l&&e.actions&&e.actions.length>0?T`
        ${kt("Actions","Start a new action",n,r)}`:""}
    </div>
  </div>
...
`:null},pa=(t,e,a,i,s)=>{if(void 0===t)return null;if(Array.isArray(t)&&1===t.length&&"View"===t[0].type&&(t=t[0]),!t.config||!t.config.template)return T`${t.map(((t,n)=>{const r=`${e}-${n}`;if("Region"===t.type)return pa(t.children,`${e}-0`,!0,i,s);if("reference"===t.type&&"view"===t.config.type){let e="";if(t.config.context&&(e=t.config.context),t.config.inheritedProps&&1===t.config.inheritedProps.length&&"label"===t.config.inheritedProps[0].prop){const n=i18n.t(t.config.inheritedProps[0].value);let o=i.data.uiResources.resources.views[t.config.name];if(o){if(Array.isArray(o)&&1===o.length&&"View"===o[0].type&&(o=o[0]),"fieldGroup"===o.config.multiRecordDisplayAs)return pa(o,r,a,i,""===s?e.substring(1):s+e);const t="SimpleTable"===o.config.template||"ListView"===o.config.template?"field-table":"field-subview";return T`<div class='flex content-item field-item ${t}'><h4>${n}</h4>${pa(o,r,a,i,""===s?e.substring(1):s+e)}</div>`}}return pa(i.data.uiResources.resources.views[t.config.name],r,a,i,s&&""!==s?s+e:e.substring(1))}return je(t,r,a,i,s)}))}`;if("SimpleTable"===t.config.template){if("fieldGroup"===t.config.multiRecordDisplayAs){const s=t.config.referenceList.replace("@P .","").replace("@USER .",""),n=ht(i.data.data.caseInfo.content,s);if(!n)return null;const r=t.config.heading.replace("@L ","");return T`${n.map(((n,o)=>T`<div><h4>${`${r} ${o}`}</h4>
  ...
  <table class='responsive'>
    ...
    <tbody>${G()}
        ...
        `;default:return null}},ga=(t,e,a,i,s,n,r,o,c,l)=>{const d=T`${at()}<span class='count-badge'>${s}</span>`;if(void 0===e.caseID&&a.content){const t=a.content.pyID.split(" ")[1];return T`
    <div class="flex layout-content-inline_middle main-header">
