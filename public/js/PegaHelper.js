(function e(t, n, r) {
	...
	1: [function (require, module, exports) {
		...
		$(document).ready(function () {
			...
			$('body').append($minL);
			var $minS = $("<div>", {
				id: "servicecaselauncherminimized",
				text: "Need Help?"
			});
			$minS.click(maximizeServiceCaseAdvisorWindow);
			$('body').append($minS);
			var $minC = $("<div>", {
				id: "ChatLauncherminimized",
				text: "Need Help?"
			});
		...
		function startcall(message) {
			...
			pega.web.api.doAction("OnlineHelp", "setGadgetData", "pyWorkPage.NavigateToCall", currentTimeInMills, {
				callback: function (obj) {
					/*console.log("submitting the call-->>"+obj);*/
				}
			});
		}
		...
		function restartAdvisor(message) {
			var currentTimeInMills = new Date().getTime();
			pega.web.api.doAction("OnlineHelp", "setGadgetData", "pyWorkPage.NavigateToAdvisorStart", currentTimeInMills, {
				callback: function (obj) {
					/*console.log("submitting the call-->>"+obj);*/
				}
			});
		...
		function startchat(message) {
			...
			/* move the survey */
			var currentTimeInMills = new Date().getTime();
			pega.web.api.doAction("OnlineHelp", "setGadgetData", "pyWorkPage.NavigateToSurvey", currentTimeInMills, {
				callback: function (obj) {
					/*console.log("submitting the chat-->>"+obj);*/
				}
			});
			...
			window.setTimeout(function () {
				initialMessageBoxDivHeight = $("#messageBoxDiv").height();
			}, 2000);
		...
		function InvokeAdvisor() {
			...
			PegaAParamObject.channelId = PegaCSWSS.WebChatBotID;

			/* if there is a vertical-specific initialization function, run it */
			if (typeof verticalWCBInit == "function") {
				verticalWCBInit(PegaAParamObject);
			}
		...
		function launchServiceCase(message) {
			...
			window.setTimeout(function () {
				$('#ServiceCaseGadget').addClass('expanded');
			}, 50);
		...
		window.document.addEventListener('startChat', function (e) {
			...
			pega.web.api.doAction("OnlineHelp", "setGadgetData", "pyWorkPage.ChatSessionId", JSON.stringify(e.detail.chatId), {
				callback: function (obj) {
					/*console.log("mytestset-->>"+obj);*/
				}
			});
		}, false);
		...
		$(function () {
			$('body').append("<div id='OnlineHelp' data-pega-gadgetname ='OnlineHelp' data-pega-action ='createNewWork' data-pega-action-param-classname ='' data-pega-action-param-flowname ='' data-pega-action-param-model ='' data-pega-applicationname ='CSSelfServiceStaging' data-pega-isdeferloaded ='true' data-pega-threadname ='CSAdvisor' data-pega-systemid ='pega' data-pega-resizetype ='fixed' data-pega-url ='" + PegaCSWSS.MashupURL + "/PRChat' data-pega-action-param-parameters ='' data-pega-redirectguests='true' data-pega-event-onclose ='hideinline'></div>");
			$('body').append("<div style='display:none; height:80px; padding-top:14px; padding-left:20px;' id='Preview' data-pega-gadgetname ='PreviewGadget' data-pega-isdeferloaded ='true' data-pega-action ='display' data-pega-action-param-classname ='PegaCS-OnlineHelp-Triage-WebChatbot'  data-pega-harnessname ='Preview' data-pega-applicationname ='CSSelfServiceStaging' data-pega-threadname ='Preview' data-pega-systemid ='pega' data-pega-resizetype ='fixed' data-pega-event-onclose ='' data-pega-url ='" + PegaCSWSS.MashupURL + "/PRChat' data-pega-action-param-parameters=''></div>");
		});
		/***********************************************************************************************************************
