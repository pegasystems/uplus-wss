...
mashupScript.onload = function() {
  ...
  $('body').append("<div id='OnlineHelp' data-pega-gadgetname='OnlineHelp' data-pega-action='createNewWork' data-pega-action-param-classname='" + PegaChatConfig.SSAWorkClass + "' data-pega-action-param-flowname='pyStartCase' data-pega-action-param-model='' data-pega-applicationname='" + PegaChatConfig.PegaApplicationName + "' data-pega-isdeferloaded='true' data-pega-isretained='true' data-pega-channelID ='" + PegaChatConfig.ChannelId + "' data-pega-threadname='CSAdvisor' data-pega-systemid='pega' data-pega-resizetype='fixed' data-pega-url='" + PegaChatConfig.PegaServerURL +"' data-pega-action-param-parameters='" + setDefaultChatGadgetParams() + "' data-pega-event-onpagedata='setDynamicChatGadgetParams' data-pega-redirectguests='true' data-pega-event-onclose='hideinline'></div>");

  $('body').append("<div id='ProactiveChat' data-pega-gadgetname='ProactiveChat' data-pega-action='createNewWork' data-pega-action-param-classname='" + PegaChatConfig.ProactiveChatClass + "' data-pega-action-param-flowname='pyStartCase' data-pega-action-param-model='' data-pega-applicationname='" + PegaChatConfig.PegaApplicationName + "' data-pega-isdeferloaded='true' data-pega-isretained='true' data-pega-channelID ='" + PegaChatConfig.ChannelId + "' data-pega-threadname='ProactiveChatThread' data-pega-systemid='pega' data-pega-resizetype='fixed' data-pega-url='" + PegaChatConfig.PegaServerURL + "' data-pega-action-param-parameters='" + setDefaultProactiveChatGadgetParams() + "' data-pega-event-onpagedata='setDynamicProactiveChatGadgetParams' data-pega-redirectguests='true' data-pega-event-oncustom='proactiveChatCustomEventHandler'></div>");
