window.langFR = {
  ...
  otp: "Vous avez activé l'authentification à deux facteurs. Veuillez entre le mot de passe à usage unique",
  invalidOTP: 'Mot de passe à usage unique is incorrect',
  requestOTPFailed: "Erreur durant l'obtention du mot de passe à usage unique",
  aboutus: 'A propos',
  ...
  billdue: 'Date de paiement',
  viewbill: 'Voir votre facture',
  autopay: 'Automatique paiement',
  off: 'Off',
  on: 'On',
  banner_icon: 'pi-warn-solid',
  banner_title: 'Uplus Assistance',
  banner_desc: "Besoin d'assistance? Cliquer sur le bouton pour demander de l'aide",
  ...
  phone_home_page_actions3_title: 'Payer ma facture',
  phone_home_page_promo_message:
    "Améliorez votre expérience avec l'application mobile. Ayez toujours accès à votre contract d'assurance meme en déplacement",
  ...
  phone_quick_links_intro_msg:
    "Remplir une declaration d'accident est tres simple et ne prends pas plus de 5 minutes.",
  phone_quick_links_intro_action: 'Commencez la declaration',
  phone_quick_links_intro_banner_msg:
    "Vous avez besoin d'une urgence medicale?",
  ...
  offer_main_offer_button_label: 'Appliquer maintenant',
  offer_footer_title:
    'Simplifiez vos opérations bancaires et commencez à gagner plus.',
  offer_footer_button_label: 'Appliquer maintenant',
  ...
  offer_cards_data2_title: 'Vérification Flex',
  offer_cards_data2_msg:
    'Un programme complet de couverture médicale pour vous protéger dans toutes les situations',
  offer_cards_data2_highlight: 'Pas de frais de guichet automatique',
  offer_cards_data3_title: 'CB Credit Card PLUS',
  offer_cards_data3_msg:
    'Un programme complet de couverture médicale pour vous protéger dans toutes les situations',
  offer_cards_data3_highlight: 'Gagnez 5% de cash back',
  offer_details1_title:
  ...
  offer_highlights_data1_title: 'Minimum du compte minimum',
  ...
  offer_highlights_data2_title: 'Remise en argent',
  ...
  category_cards_data2_msg: "Obtenez 4% de remise en argent sur les repas, 3% sur le prix de l'essence et 2% sur les autres achats.",
  ...
  category_cards_data3_msg: "Évitez les frais de transaction à l'étranger et gagnez des points sur les achats des compagnies aériennes.",
  ...
  category_details1_msg: "La carte U+ Bank Cash Rewards vous permet de récupérer de l'argent sur chaque achat.",
  ...
  category_highlights_data1_msg: "Profitez d'un service de classe mondiale et d'une protection contre les retours",
  category_highlights_data2_title: 'Sûreté et sécurité',
  category_highlights_data2_msg: 'Les cartes à puce constituent un niveau de sécurité supplémentaire',
  category_highlights_data3_title: 'Acceptation de la carte',
  category_highlights_data3_msg: "Les cartes bancaires U+ sont désormais acceptées dans plus d'endroits que jamais",
  category_footer_title: 'Simplifiez vos opérations bancaires et commencez à gagner plus.',
};
